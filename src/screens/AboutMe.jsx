    ...
    return (
        <div className="bg-[#060606] h-full text-white font-main flex space-x-8">
            ...
            <div className='w-5/12 h-full'>
                <motion.div className='fixed bg-gradient-to-r from-[#232526] to-[#414345] h-5/12 w-3/12 text-center rounded-3xl p-3 top-[20%] left-[8%]'
                initial={{scale: 1.1}}
                animate={{scale: 1}}
            ...
            <motion.div className='w-7/12 pb-8'
            ref={ref}
            variants={{
            ...
            transition={{duration: 0.5, delay: 0.25}}>
                ...
                <p className='mt-4 w-8/12'>At the first semester of my second year studies, I was a laboratory demonstrator for first year IT students. I was helping them understand programming fundamentals using Python.</p>
                ...
                <p className='mt-4 w-8/12'>I finished my high school studies in my local town. Here I started exploring more about the IT world and fell in love with web development. I was awarded with "The student of the generation" award because I had a GPA of 5.0/5.0 through all 4 years of my studies.</p>
                ...
                <p className='mt-4 w-8/12'>At the moment, I am a undergraduate student at International Burch University and I just finished my third semester of studies. I enjoy studying here because the professors at the Univeristy are keeping up to date with the latest trends in the IT world.</p>
                ...
                <div className='grid grid-row-cols grid-row-2 my-8 text-center'>
                    ...
                    <h1 className='w-8/12 mt-4 text-lg'>React Native</h1>
                    <ProgressBar bgcolor={"#a67c00"} completed={90} />

                    <h1 className='w-8/12 mt-4 text-lg'>SQL</h1>
                    <ProgressBar bgcolor={"#a67c00"} completed={80} />

                    <h1 className='w-8/12 mt-4 text-lg'>Python</h1>
                    <ProgressBar bgcolor={"#a67c00"} completed={70} />

                    <h1 className='w-8/12 mt-4 text-lg'>CSS</h1>
                    <ProgressBar bgcolor={"#a67c00"} completed={90} />

                    <h1 className='w-8/12 mt-4 text-lg'>Node.js</h1>
                    <ProgressBar bgcolor={"#a67c00"} completed={70} />

                    <h1 className='w-8/12 mt-4 text-lg'>Java Spring</h1>
                    <ProgressBar bgcolor={"#a67c00"} completed={40} />
                </div>
                <h1 className='text-xl uppercase mt-16'>Awards, certifications, courses</h1>

                <h3 className='mt-8 text-[#A9A9A9]'>2019 | Mixed high school in Gornji Vakuf</h3>
                <h3 className='text-lg leading-4 text-[#a67c00]'>Student of generation award</h3>

                <h3 className='mt-8 text-[#A9A9A9]'>2023 | GOOD HACKathon</h3>
                <h3 className='text-lg leading-4 text-[#a67c00]'>Developed a mobile application on the theme "Modern ways of studying"</h3>

                <h3 className='mt-8 text-[#A9A9A9]'>2021 | The Web Developer Bootcamp</h3>
                <h3 className='text-lg leading-4 text-[#a67c00]'>Upgraded my previous knowledge about web development</h3>

                <h3 className='mt-8 text-[#A9A9A9]'>2023 | React Native - The Practical Guide</h3>
                <h3 className='text-lg leading-4 text-[#a67c00]'>Started getting interested in mobile development, so I followed this course to learn more about.</h3>

                <h3 className='mt-8 text-[#A9A9A9]'>2024 | Node.js, Express, MongoDB & More: The Complete Bootcamp</h3>
                <h3 className='text-lg leading-4 text-[#a67c00]'>At the moment, expanding my knowledge about Back End development</h3>
            </motion.div>
        </div>
  )
}
