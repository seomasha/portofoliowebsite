...
function IconBlock({height, width, image, subtitle, title, icon, icon2, icon3, icon4, link, link2, link3, link4, link5, link6, icon5, icon6}) {
  return (
    <div className='bg-gradient-to-r from-[#232526] to-[#414345] flex rounded-3xl p-4 mt-auto flex-col justify-between' style={{height: height, width: width}}>
