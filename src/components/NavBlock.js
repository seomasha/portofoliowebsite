...
function NavBlock({height, width, image, subtitle, title, button}) {
  return (
    <div className='bg-[#1D1D1D] flex rounded-3xl p-4 mt-auto flex-col' style={{height: height, width: width}}>
        ...
        <div className='flex justify-between'>
            ...
            <RxExternalLink className='my-auto text-lg text-[#A9A9A9] hover:text-[#a67c00] transition cursor-pointer'/>
        </div>
    </div>
  )
}
